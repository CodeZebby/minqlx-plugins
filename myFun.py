...
class myFun(minqlx.Plugin):
    def __init__(self):
        ...
        # Enable/Disable sound pack files
        self.set_cvar_once("qlx_funEnableSoundPacks", "127")
        # Join sound path/file ("0" disables sound)
        ...
        self.Enabled_SoundPacks = [0, 0, 0, 0, 0, 0, 1]
        ...
        self.soundPacks = ["Default Quake Live Sounds", "Prestige Worldwide Soundhonks", "Funny Sounds Pack for Minqlx",
                           ...
                           "West Coast Crew Sound", 'Zebby Sound Pack']
        # List of sound pack categories (used to narrow search results in !listsounds)
        self.categories = ["#Default", "#Prestige", "#Funny", "#Duke", "#Warp", "#West", '#Zebby']
    ...
    def populate_database(self):
        ...
        # add local sounds
        if self.Enabled_SoundPacks[6]:
            self.db.set(SOUND_TRIGGERS.format(6, "weaboo"), "^weaboo\\W?$;sound/chat/weaboo.ogg")
